 ...
 */
public class FileConsumerConfigurationPropertiesTests {
	...
	public void fileReadingModeCanBeCustomized() {
		...
		context.refresh();
		FileConsumerConfigurationProperties properties = context.getBean(FileConsumerConfigurationProperties.class);
	...
	@Configuration
	@EnableConfigurationProperties(FileConsumerConfigurationProperties.class)
	static class Conf {
	}
}
