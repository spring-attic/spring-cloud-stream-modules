 ...
 */
public class PeriodicTriggerConfigurationPropertiesTests {
	...
	public void fixedDelayCanBeCustomized() {
		...
		context.refresh();
		PeriodicTriggerConfigurationProperties properties = context.getBean(PeriodicTriggerConfigurationProperties
				.class);
