...
$$deliveryMode$$:: $$the default delivery mode (PERSISTENT, NON_PERSISTENT)$$ *($$String$$, default: `NON_PERSISTENT`)*
...
In addition, a custom converter bean can be added to the context and referenced by this property.
...
git ccollection type to point to a specific data store.
