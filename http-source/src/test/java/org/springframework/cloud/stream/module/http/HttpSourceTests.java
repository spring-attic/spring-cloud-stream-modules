...
public abstract class HttpSourceTests {
	...
	@WebIntegrationTest(value = "pathPatterns=/foo")
	...
	@WebIntegrationTest({"pathPatterns=/bar", "payloadExpression=body.substring(0,4)", "methods=PUT"})
	public static class ComplexConfigurationTests extends HttpSourceTests {

		@Test
		public void testSimplePOST() {
			restTemplate.put("http://localhost:" + port + "/bar", "hello");
			assertThat(messageCollector.forChannel(channels.output()), receivesPayloadThat(is("hell")));
		}
